...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  Relational databases are a style of data orgnazition that uses tables and the mathematical relationship between tables and row. SQL is the query language used to search and sort data within a database.

- [ ] Why do tables need a `primary key`?

  A primary key is typically column within a relational database that uniquely identifies each record(row).
...
you need an intermediary table that uses a foreign key to reference another primary key in another table.
